...
C接口详细介绍请阅读[《NNToolChain用户开发手册》](https://doc.sophgo.com/docs/2.7.0/docs\_latest\_release/nntc/html/index.html)中的[BMRuntime使用章节](https://doc.sophgo.com/docs/2.7.0/docs\_latest\_release/nntc/html/usage/runtime.html)。

​Python接口详细介绍请阅读[《SAIL用户开发手册》](https://doc.sophgo.com/docs/2.7.0/docs\_latest\_release/sophon-inference/html/index.html)。
